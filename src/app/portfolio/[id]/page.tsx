        ...
        <div className="flex flex-wrap">
          <div className="w-full sm:w-1/2 lg:order-2">
            <div data-offset-top={0}>
              <div className="p-1 pb-4 md:pl-2 md:pr-4 lg:py-24 lg:pr-16 lg:pl-24">
                ...
                <table className="w-full">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="w-auto pr-0 pt-1">{portfolioItem.tech}</td>
                    </tr>
                    <tr>
                      <td className="w-24 pt-1 pb-1 pr-2 align-top">
                        <strong className="font-medium text-[#252b33]">
                    ...
                    <tr>
                      ...
                      <td className="w-auto pr-0 pt-1">{portfolioItem.year}</td>
                    </tr>
                    {portfolioItem.url && (
                      <tr>
                        <td className="w-24 pt-1 pb-1 pr-2 align-top">
      ...
      <div className="text-center py-8 bg-white">
        <div className="w-full px-4 flex flex-row justify-between items-center">
          ...
          {portfolioItems.length > itemIndex + 1 && (
            <Link
              href={portfolioItems[itemIndex + 1].route}
              className="ml-auto flex flex-row items-center justify-center text-inherit no-underline transition-opacity duration-500 hover:opacity-60"
              onClick={(event) =>
                goToItemHandler(event, portfolioItems[itemIndex + 1].route)
              }
            >
