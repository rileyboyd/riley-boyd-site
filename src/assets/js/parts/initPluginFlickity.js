...
function initPluginFlickity() {
  ...
  function addDefaultArrows($carousel) {
    $(
      '<div class="rb-flickity-arrow rb-flickity-arrow-prev"><span class="pe-7s-angle-left"></span></div>'
    )
      .on('click', () => {
    ...
    $(
      '<div class="rb-flickity-arrow rb-flickity-arrow-next"><span class="pe-7s-angle-right"></span></div>'
    )
      .on('click', () => {
    ...
    $carousel3.each(function () {
      ...
      $allImages.each(function () {
        if (
          this.naturalWidth &&
          this.naturalHeight &&
          (resultH * this.naturalWidth) / this.naturalHeight > maxItemW
        ) {
  ...
  const $storeCarousel = $(
    '.rb-carousel-1, .rb-carousel-2, .rb-carousel-3'
  ).filter('.rb-store')
