...
function initVideoBlocks() {
  ...
  self.openFullScreenVideo = (url) => {
    ...
    if (!self.FullScreenVideo) {
      self.FullScreenVideo = $(
        '<div class="rb-video-fullscreen"></div>'
      ).appendTo($body)
      ...
      // video container
      self.FullScreenVideoWrapper = $(
        '<div class="rb-video-fullscreen-cont"></div>'
      ).appendTo(self.FullScreenVideo)
  ...
  function addPlainPlayButton($plainCont) {
    $plainCont
      .find('.rb-video-plain-toggle')
      .html(self.options.templates.plainVideoIcon)
  }
  function addPlainLoadButton($plainCont) {
    $plainCont
      .find('.rb-video-plain-toggle')
      .html(
        self.options.templates.plainVideoLoadIcon ||
          self.options.templates.plainVideoIcon
      )
  }
